...
config.JobType.inputFiles = ['produce_Wto3l_Zp_M15.sh','retrieve_fragment.sh','fragment-Wto3l-RunIISummer20UL17wmLHEGEN.py','Gridpacks/WmTo3l_M'+Mass+'_tarball.tar.xz','FrameworkJobReport.xml']
